                    ...
                    while($fila=mysql_fetch_array($checkSection)){
                        ...
                        echo '<div class="div-table-row">
                            ...
                            if(mysql_num_rows($checkSectionTeacher)>0 || mysql_num_rows($checkSectionStudent)>0){ 
                                ...
                                echo '<form class="div-table-cell form_SRCB" action="../controller/DeleteSection.php" method="post" data-type-form="delete" ><input value="' .$fila["CodigoSeccion"].'" type="hidden" name="primaryKey"><button type="submit" class="btn btn-danger btn-xs"><i class="zmdi zmdi-delete"></i> &nbsp;&nbsp; Eliminar</button></form>';
                            }
                        echo '</div>';
                        $p++;
