    ...
    <script>
        $(document).ready(function(){
            ...
            $('.btn-delete').on('click', function(){
                var process=$(this).attr('data-controller');
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="modal fade" id="ModalRestore" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="../controller/RestoreSystem.php" method="post" data-type-form="restorePoint" autocomplete="off">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
