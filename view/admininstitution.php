    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form action="../controller/AddInstitution.php" method="post" class="form_SRCB" data-type-form="save" autocomplete="off">
                    <div class="row">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form action="../controller/UpdateInstitution.php" method="post" class="form_SRCB" data-type-form="update" autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                    ...
                    <div class="col-xs-12">
                        <?php 
                            ...
                            if(mysql_num_rows($checkInstitutionBook)>=1){
                                ...
                                echo '<form action="../controller/DeleteInstitution.php" method="post" class="form_SRCB" data-type-form="delete">   
