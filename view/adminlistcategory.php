    ...
    <div class="content-page-container full-reset custom-scroll-containers">
                        ...
                        echo '<div class="div-table-row">
                            ...
                            <div class="div-table-cell">';
                                ...
                                if(mysql_num_rows($checkBookCategory)>=1){
                                    ...
                                    echo '<button class="btn btn-success btn-update" data-code="'.$fila['CodigoCategoria'].'" data-url="../controller/SelectDataCategory.php"><i class="zmdi zmdi-refresh"></i></button>';
                                }
                            echo '</div>';
                            if(mysql_num_rows($checkBookCategory)>=1){
                                echo '<div class="div-table-cell"><button class="btn btn-danger" disabled="disabled"><i class="zmdi zmdi-delete"></i></button></div>';
                            }else{
                                echo '<form class="div-table-cell form_SRCB" action="../controller/DeleteCategory.php" method="post" data-type-form="delete"><input value="' .$fila['CodigoCategoria'].'" type="hidden" name="primaryKey"><button type="submit" class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></form>';
                            }
        ...
        <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="../controller/UpdateCategory.php" method="post" data-type-form="update" autocomplete="off">
