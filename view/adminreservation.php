    ...
    <script>
        $(document).ready(function(){
            ...
            $('.btn-reservation').on('click', function(){
                ...
                $.ajax({
                    url:'../controller/checkReservationData.php',
                    type: 'POST',
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
                            ...
                            <div class="table-responsive">
                                <div class="div-table" style="margin:0 !important;">
                                    <div class="div-table-row div-table-row-list">
                                        ...
                                        <form action="../controller/DeleteReservation.php" method="post" class="div-table-cell form_SRCB" data-type-form="deleteReservation" style="width: 8%;">
        ...
        <div class="modal fade" tabindex="-1" role="dialog" id="modalR">
            <div class="modal-dialog" role="document">
                <form class="modal-content form_SRCB" action="../controller/UpdateReservation.php" method="post" data-type-form="approveReservation" >
