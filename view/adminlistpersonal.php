    ...
    <div class="content-page-container full-reset custom-scroll-containers">
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 9%;"><button class="btn btn-success btn-update" data-code="'.$dataP['DUI']. '" data-url="../controller/SelectDataPersonal.php"><i class="zmdi zmdi-refresh"></i></button></div>
                                            <form class="div-table-cell form_SRCB" action="../controller/DeletePersonal.php" method="post" data-type-form="delete" style="width: 9%;">
                                ...
                                <div class="table-responsive">
                                    <div class="div-table" style="margin:0 !important;">
                                        <div class="div-table-row div-table-row-list">
                                            ...
                                            <div class="div-table-cell" style="width: 9%;"><button class="btn btn-success btn-update" data-code="'.$data['DUI']. '" data-url="../controller/SelectDataPersonal.php"><i class="zmdi zmdi-refresh"></i></button></div>
                                            <form class="div-table-cell form_SRCB" action="../controller/DeletePersonal.php" method="post" data-type-form="delete" style="width: 9%;">
        ...
        <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
              <form class="form_SRCB modal-content" action="../controller/UpdatePersonal.php" method="post" data-type-form="update" autocomplete="off">
