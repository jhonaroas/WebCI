    ...
    <div class="content-page-container full-reset custom-scroll-containers">
                ...
                if(mysql_num_rows($checkProvider)>0){
                    ...
                    while($fila=mysql_fetch_array($checkProvider)){
                        echo '<div class="div-table-row">
                            ...
                            <div class="div-table-cell"><button class="btn btn-success btn-update" data-code="'.$fila['CodigoProveedor'].'" data-url="../controller/SelectDataProvider.php"><i class="zmdi zmdi-refresh"></i></button></div>';
                            ...
                            if(mysql_num_rows($checkBookProvider)>=1){
                                ...
                                echo '<form class="div-table-cell form_SRCB" action="../controller/DeleteProvider.php" method="post" data-type-form="delete"><input value="' .$fila['CodigoProveedor'].'" type="hidden" name="primaryKey"><button type="submit" class="btn btn-danger"><i class="zmdi zmdi-delete"></i></button></form>';
                            }
        ...
        <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="../controller/UpdateProvider.php" method="post" data-type-form="update" autocomplete="off">
