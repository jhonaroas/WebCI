    ...
    <div class="content-page-container full-reset custom-scroll-containers">
                    ...
                    while($fila=mysql_fetch_array($checkAdmin)){
                        echo '<div class="div-table-row">
                                ...
                                if($fila['Estado']=='Activo'){
                                    ...
                                    echo '
                                    <form class="div-table-cell form_SRCB" action="../controller/DisabledAdmin.php" method="post" data-type-form="updateAccounAdmin" >
                                    ...
                                    <div class="div-table-cell"><button class="btn btn-success btn-update" data-code="'.$fila['CodigoAdmin'].'" data-url="../controller/SelectDataAdmin.php"><i class="zmdi zmdi-refresh"></i></button></div>';
                                    if(mysql_num_rows($checkAdminLoan)>0){
                                        ...
                                        echo '<form class="div-table-cell form_SRCB" action="../controller/DeleteAdmin.php" method="post" data-type-form="delete" >
                                            <input value="' .$fila["CodigoAdmin"].'" type="hidden" name="primaryKey">
                                    ...
                                    echo '
                                    <form class="div-table-cell form_SRCB" action="../controller/ActivateAdmin.php" method="post" data-type-form="updateAccounAdmin" >
                                        <input value="' .$fila["CodigoAdmin"].'" type="hidden" name="primaryKey">
        ...
        <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="../controller/UpdateAdmin.php" method="post" data-type-form="update" autocomplete="off">
