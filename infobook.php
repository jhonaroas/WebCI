...
<body>
    <?php  
        ...
        include './controller/SecurityUser.php';
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12">
                    <?php
                    echo '<a href="controller/imagenes_/'.$fila['CodigoCorrelativo'].'_0.jpg" data-lightbox="galeria" data-title="Portada libro"><img src="controller/imagenes_/'.$fila['CodigoCorrelativo'].'_0.jpg" class="img-responsive center-box" style="max-height: 250px;"></a>
                        <br>
                        <center><a class="btn btn-primary view-pdf" href="controller/pdf_/'.$fila['CodigoCorrelativo'].'.pdf">Ver libro PDF</a></center>';
                    ?>
                    <br>
                </div>
                <div class="col-xs-12">
        ...
        <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog">
          <div class="modal-dialog" role="document">
            <form class="form_SRCB modal-content" action="controller/UpdateBook.php" method="post" data-type-form="update" autocomplete="off">
